...
describe('searchVehicles', () => {
    ...
    describe('when user already exists', () => {
        ...
        it('should succeed on non-matching query returning an empty array', () => 
            searchVehicles(token, 'asdasdfñlajsfklasldñkfjañlsjflasjflasjfñladjs').then(results => {
        ...
        describe('when fav vehicles already exists', () => {
            ...
            it('should get results on matching query with favs as previously added', () => {
                return searchVehicles(token, query).then(vehicles => {
                    expect(vehicles).toBeDefined()
                    expect(vehicles.length).toBeGreaterThan(0)
        ...
        it('should fail on invalid token', () => 
            searchVehicles(`${token}-wrong`, query).then(() => {throw new Error ('Should not reach this point')})
            .catch(error => {
